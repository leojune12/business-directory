            ...
            <div class="tw-bg-white md:tw-p-6 tw-p-4 tw-rounded-md">
                <div class="tw-mb-7">
                    ...
                    <div class="tw-flex tw-items-start tw-mb-4 tw-text-gray-600">
                        <div>
                            <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="tw-mr-3 tw-text-gray-400">
                ...
                <div class="tw-mb-7">
                    ...
                    <div class="tw-flex tw-items-start tw-mb-4 tw-text-gray-600">
                        <div>
                            <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="tw-mr-3 tw-text-gray-400">
