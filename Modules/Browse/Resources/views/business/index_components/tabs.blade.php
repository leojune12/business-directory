<div class="tw-bg-white tw-drop-shadow">
    <v-container
        class="tw-py-0 tw-flex tw-justify-center"
    >
        <ul class="tw-flex tw-flex-wrap tw--mb-px tw-text-sm tw-font-medium tw-text-center tw-pl-0">
            <li class="tw-mr-2">
                <a href="/browse" class="md:tw-p-4 tw-py-3 tw-px-4 tw-rounded-t-lg tw-text-blue-500 hover:tw-text-blue-600 tw-group tw-no-underline tw-flex tw-items-center tw-justify-center tw-gap-x-2">
            ...
            <li class="mr-2">
                <a href="/browse/products" class="md:tw-p-4 tw-py-3 tw-px-4 tw-rounded-t-lg tw-text-gray-400 hover:tw-text-blue-500 tw-group tw-no-underline tw-flex tw-items-center tw-justify-center tw-gap-x-2" aria-current="page">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <li class="mr-2">
                <a href="/browse/services" class="md:tw-p-4 tw-py-3 tw-px-4 tw-rounded-t-lg tw-text-gray-400 hover:tw-text-blue-500 tw-group tw-no-underline tw-flex tw-items-center tw-justify-center tw-gap-x-2" aria-current="page">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <li class="mr-2">
                <a href="/browse/categories" class="md:tw-p-4 tw-py-3 tw-px-4 tw-rounded-t-lg tw-text-gray-400 hover:tw-text-blue-500 tw-group tw-no-underline tw-flex tw-items-center tw-justify-center tw-gap-x-2" aria-current="page">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <li class="mr-2">
                <a href="/browse/jobs" class="md:tw-p-4 tw-py-3 tw-px-4 tw-rounded-t-lg tw-text-gray-400 hover:tw-text-blue-500 tw-group tw-no-underline tw-flex tw-items-center tw-justify-center tw-gap-x-2" aria-current="page">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
