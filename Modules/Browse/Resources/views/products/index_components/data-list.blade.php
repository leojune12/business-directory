            ...
            >
                <div class="tw-bg-white tw-rounded-sm tw-overflow-hidden tw-drop-shadow tw-w-full tw-flex tw-flex-col tw-justify-between">
                    ...
                    <div class="tw-p-2 tw-grid tw-grid-cols-1">
                        <div class="tw-text-sm tw-font-semibold- tw-text-gray-700 tw-mb-3 bd-truncate-overflow">
                            @{{ item.name }}
                        </div>
                        ...
                        <div class="tw-text-xs tw-text-gray-700 tw-font-normal tw-flex">
                        ...
                        <div class="tw-flex">
                            ...
                            <div>
                                <div class="tw-text-xs tw-font-light tw-text-gray-700 bd-truncate-overflow-sm">
